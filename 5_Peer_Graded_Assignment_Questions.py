...
app.layout = html.Div(children=[ 
    ...
    # Enter your code below. Make sure you have correct formatting.
    html.Div([
        html.Div(id='plot4', style={'flex': '1'}),
        html.Div(id='plot5', style={'flex': '1'})
    ], style={'display': 'flex'})
])
...
def update_graphs(option_selected, entered_year, children1, children2, children3, children4, children5):
    # function code
